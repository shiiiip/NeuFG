...
from models.renderer import NeuFGRenderer, get_psnr
...
class Runner:
    def __init__(self, conf_path, mode='train', case='CASE_NAME', is_continue=False, checkpoint=False, suffix=''):
        ...
        self.renderer = NeuFGRenderer(self.nerf_outside,
                                     self.sdf_network,
    ...
    def train(self):
        ...
        for iter_i in tqdm(range(res_step)):
            ...
            delta_val = render_out['delta_val']
            ...
            self.writer.add_scalar('Statistics/delta_val', delta_val.mean(), self.iter_step)
